...
todo4: By pressing the arrow left and arrow right keys, we should change the value of the positionX variable 
(add or subtract the number 5 for each press) and by pressing the arrow down and arrow up keys,
 we should change the value of the positionY variable.
